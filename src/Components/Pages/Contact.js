...
import { Container, Typography, Box, Grid, TextField, Button, Paper, CircularProgress, Alert } from '@mui/material';
  ...
  return (
    <Container maxWidth="lg" className="contact-container">
      <Box textAlign="center" marginBottom={4}>
        <Typography variant="h3" className="contact-header">
          Get In Touch
        </Typography>
      ...
      <Grid container spacing={4} justifyContent="center">
        <Grid item xs={12} md={6}>
          <Paper elevation={3} className="contact-form">
            <Box padding={3}>
              <Typography variant="h4" className="contact-form-header">
                Send Feedback
              </Typography>
